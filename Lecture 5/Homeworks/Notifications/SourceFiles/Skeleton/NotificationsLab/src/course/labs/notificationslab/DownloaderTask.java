		...
		mApplicationContext.sendOrderedBroadcast(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (/*change this true)*/getResultCode() != Activity.RESULT_OK) {
							...
							Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext).setContent(mContentView).setContentIntent(pendingIntent).setSmallIcon(android.R.drawable.stat_sys_warning).setAutoCancel(true);
